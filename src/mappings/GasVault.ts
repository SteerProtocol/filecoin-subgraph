...
import { GasWithdrawn } from '../../generated/DynamicJobs/DynamicJobs';
import {EtherUsed, Withdrawn, Deposited} from '../../generated/GasVault/GasVault';
import { Job, OrchestratorAction, Vault, VaultGasDeposited, VaultGasUsed, VaultGasWithdrawn } from '../types/schema';
...
export function handleEtherUsed(event: EtherUsed): void {
    ...
    const orchestratorAction = OrchestratorAction.load(event.transaction.hash.toHexString());

...
export class VaultUpgraded__getPositionsResult {
  value0: Array<i32>;
  value1: Array<i32>;
  value2: Array<i32>;
...
export class VaultUpgraded extends ethereum.SmartContract {
  ...
  getPositions(): VaultUpgraded__getPositionsResult {
    let result = super.call(
      "getPositions",
    ...
    return new VaultUpgraded__getPositionsResult(
      result[0].toI32Array(),
      result[1].toI32Array(),
      result[2].toI32Array()
    );
  ...
  try_getPositions(): ethereum.CallResult<VaultUpgraded__getPositionsResult> {
    let result = super.tryCall(
      "getPositions",
      "getPositions():(int24[],int24[],uint16[])",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VaultUpgraded__getPositionsResult(
        value[0].toI32Array(),
        value[1].toI32Array(),
        value[2].toI32Array()
      )

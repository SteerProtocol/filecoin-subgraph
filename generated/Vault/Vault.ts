...
export class Vault__getPositionsResult {
  value0: Array<i32>;
  value1: Array<i32>;
  value2: Array<i32>;

  constructor(value0: Array<i32>, value1: Array<i32>, value2: Array<i32>) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
  }
...
export class Vault extends ethereum.SmartContract {
  ...
  getPositions(): Vault__getPositionsResult {
    let result = super.call(
      "getPositions",
    ...
    return new Vault__getPositionsResult(
      result[0].toI32Array(),
      result[1].toI32Array(),
      result[2].toI32Array()
    );
  ...
  try_getPositions(): ethereum.CallResult<Vault__getPositionsResult> {
    let result = super.tryCall(
      "getPositions",
      "getPositions():(int24[],int24[],uint16[])",
      []
...
export class SetTWAPnumsCall extends ethereum.Call {
  get inputs(): SetTWAPnumsCall__Inputs {
    return new SetTWAPnumsCall__Inputs(this);
  }

  get outputs(): SetTWAPnumsCall__Outputs {
    return new SetTWAPnumsCall__Outputs(this);
  }
}

export class SetTWAPnumsCall__Inputs {
  _call: SetTWAPnumsCall;

  constructor(call: SetTWAPnumsCall) {
    this._call = call;
  }
...
export class SetTWAPnumsCall__Outputs {
  _call: SetTWAPnumsCall;
